...
public class Func_SubMng {
    ...
    public static void save(
        ...
        String new_subject = in_new_subject.getText();
        ...
        if (in_status.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(parentFrame,"Please Update Status");
            return;
        }
