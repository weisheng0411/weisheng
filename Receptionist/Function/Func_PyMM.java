...
public class Func_PyMM {
    ...
    public static void update(
        ...
        receipt(status,name,amount_payable,total_collected);
    ...
    public static void receipt(String in_status,String in_name,String in_AP,String in_TC){
        ...
        if (status.equals("Paid")){
            Page_receipt page = new Page_receipt(name,amount_payable,total_collected);
