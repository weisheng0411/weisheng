...
public class Func_RnM_Stu {
    ...
    public static void register(
        ...
        if (name.isEmpty() || username.isEmpty() || password.isEmpty() || IC.isEmpty()|| email.isEmpty()|| CN.isEmpty()|| address.isEmpty()){
        ...
        {stu_id,name,username,password,email,CN,address,EL,IC,subject1+ " (" + tutor1 +")",subject2+ " (" + tutor2 +")",subject3+ " (" + tutor3 +")",MOE});
